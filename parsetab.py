...
_lr_productions = [
  ...
  ('start -> program','start',1,'p_start','wparser.py',19),
  ('program -> stmntwrap program','program',2,'p_program','wparser.py',26),
  ('program -> ifblock program','program',2,'p_program','wparser.py',27),
  ('program -> while program','program',2,'p_program','wparser.py',28),
  ('program -> for program','program',2,'p_program','wparser.py',29),
  ('program -> <empty>','program',0,'p_program','wparser.py',30),
  ('stmntwrap -> statement COLON','stmntwrap',2,'p_stmntwrap','wparser.py',40),
  ('for_tail -> statement','for_tail',1,'p_for_tail','wparser.py',44),
  ('statement -> INT ID is_assing','statement',3,'p_statement_declare_int','wparser.py',48),
  ('statement -> FLOAT ID is_assing','statement',3,'p_statement_declare_float','wparser.py',52),
  ('statement -> STRING ID is_assing','statement',3,'p_statement_declare_string','wparser.py',56),
  ('statement -> BOOLEAN ID is_assing','statement',3,'p_statement_declare_boolean','wparser.py',60),
  ('ifblock -> IF LPTHESES condition RPTHESES LCURLY program RCURLY ifcont','ifblock',8,'p_ifblock','wparser.py',64),
  ('ifcont -> elifblock','ifcont',1,'p_ifcont','wparser.py',77),
  ('ifcont -> elseblock','ifcont',1,'p_ifcont','wparser.py',78),
  ('ifcont -> <empty>','ifcont',0,'p_ifcont','wparser.py',79),
  ('elseblock -> ELSE LCURLY program RCURLY','elseblock',4,'p_elseblock','wparser.py',87),
  ('elifblock -> ELIF LPTHESES condition RPTHESES LCURLY program RCURLY ifcont','elifblock',8,'p_elifblock','wparser.py',94),
  ('while -> WHILE LPTHESES condition RPTHESES LCURLY program RCURLY','while',7,'p_while','wparser.py',106),
  ('for -> FOR LPTHESES stmntwrap condition COLON for_tail RPTHESES LCURLY program RCURLY','for',10,'p_for','wparser.py',116),
  ('condition -> BOOLVAL appendcond','condition',2,'p_condition','wparser.py',128),
  ('condition -> comparison appendcond','condition',2,'p_condition','wparser.py',129),
  ('appendcond -> AND condition','appendcond',2,'p_appendcond','wparser.py',144),
  ('appendcond -> OR condition','appendcond',2,'p_appendcond','wparser.py',145),
  ('appendcond -> <empty>','appendcond',0,'p_appendcond','wparser.py',146),
  ('comparison -> expression EQUAL expression','comparison',3,'p_comparison','wparser.py',158),
  ('comparison -> expression NOTEQUAL expression','comparison',3,'p_comparison','wparser.py',159),
  ('comparison -> expression GTHAN expression','comparison',3,'p_comparison','wparser.py',160),
  ('comparison -> expression LTHAN expression','comparison',3,'p_comparison','wparser.py',161),
  ('comparison -> expression GEQTHAN expression','comparison',3,'p_comparison','wparser.py',162),
  ('comparison -> expression LEQTHAN expression','comparison',3,'p_comparison','wparser.py',163),
  ('is_assing -> ASSIGN expression','is_assing',2,'p_is_assing','wparser.py',185),
  ('is_assing -> <empty>','is_assing',0,'p_is_assing','wparser.py',186),
  ('statement -> PRINT LPTHESES expression RPTHESES','statement',4,'p_statement_print','wparser.py',195),
  ('statement -> ID ASSIGN expression','statement',3,'p_statement_assign','wparser.py',201),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','wparser.py',212),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','wparser.py',213),
  ('expression -> expression MULT expression','expression',3,'p_expression_binop','wparser.py',214),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','wparser.py',215),
  ('expression -> expression EXP expression','expression',3,'p_expression_binop','wparser.py',216),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','wparser.py',236),
  ('expression -> LPTHESES expression RPTHESES','expression',3,'p_expression_group','wparser.py',244),
  ('expression -> INUM','expression',1,'p_expression_inumber','wparser.py',249),
  ('expression -> FNUM','expression',1,'p_expression_fnumber','wparser.py',254),
  ('expression -> BOOLVAL','expression',1,'p_expression_boolean','wparser.py',258),
  ('expression -> STRVAL','expression',1,'p_expression_strval','wparser.py',262),
  ('expression -> ID','expression',1,'p_expression_name','wparser.py',266),
]
