...
_lr_productions = [
  ...
  ('is_assing -> = expression','is_assing',2,'p_is_assing','compiler.py',68),
  ('is_assing -> <empty>','is_assing',0,'p_is_assing','compiler.py',69),
  ('statement -> FLOATDEC NAME','statement',2,'p_statement_declare_float','compiler.py',75),
